...
probie allows the mapping of input strings to methods, using regular
...
And we set up the probie itself

>>> import probie
>>> probie_tool = probie.Probie()
...
The probie tool parses inputs and runs methods as mapped.

>>> probie_tool.parse("printinput hello world")
handled: 'hello world'
...
>>> probie_tool.parse("incorrectinput hello world")
...
Firstly we create a new probie tool
...
>>> probie_tool.bind_from_xml(xmlfile)

And try out the two mappings

>>> probie_tool.parse("printme hello")

>>> probie_tool.parse("multiply(6,2)")

>>> probie_tool.parse("noargs")
